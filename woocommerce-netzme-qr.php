 ...
 * Plugin URI: https://wordpress.org/plugins/woo-netzme-qr
...
class WC_Gateway_netzmeqr extends WC_Payment_Gateway 
{
	...
	public function __construct() 
	{
		...
		$this->method_description = __( 'Allows Netzme QRIS Payment', 'wc-gateway-netzmeqr' );
	...
	public function init_form_fields() 
	{
		...
		$this->form_fields = apply_filters( 'wc_netzmeqr_form_fields', array(
			...
			'enabled' => array(
				...
				'type'    => 'checkbox',
				'label'   => __( 'Enable Netzme QRIS Payment', 'wc-gateway-netzmeqr' ),
				'default' => 'yes'
			),
			'title' => array(
				...
				'default'     => __( 'QRIS Netzme Payment', 'wc-gateway-netzmeqr' ),
				'desc_tip'    => true,
			),
			'baseUrl' => array(
				'title'       => __( 'Base Url', 'wc-gateway-netzmeqr' ),
				'type'        => 'text',
				'description' => __( 'Base Url', 'wc-gateway-netzmeqr' ),
				'default'     => __( 'https://tokoapi-stg.netzme.com', 'wc-gateway-netzmeqr' ),
				'desc_tip'    => true,
			),
			'payBaseUrl' => array(
				'title'       => __( 'Pay Base Url', 'wc-gateway-netzmeqr' ),
				'type'        => 'text',
				'description' => __( 'Pay BaseUrl.', 'wc-gateway-netzmeqr' ),
	...
	function receipt_page($order_id)
	{
	   ...
	   //check if order alrea
		...
		$body = wp_json_encode($named_array);
		$now = gmdate(DATE_ATOM);
